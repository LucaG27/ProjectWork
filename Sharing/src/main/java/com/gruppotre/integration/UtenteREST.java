...
public class UtenteREST {
    ...
    @GetMapping("/getByPrenotazione/{id}")
	public ResponseEntity<Utente> findByPrenotazione(@PathVariable("id") int prenotazioneId){
		return new ResponseEntity<Utente>(srv.getByPrenotazione(prenotazioneId), HttpStatus.OK);
	}
